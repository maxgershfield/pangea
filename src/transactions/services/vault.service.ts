...
export class VaultService {
	 ...
	 */
	async getVaultAddress(assetId: string, blockchain: string): Promise<string> {
		...
		this.logger.log(`No vault found for asset ${assetId} on ${blockchain}. Deploying new vault...`);
